...
<header>
    <div class="container">
        <p class="address">г. Казань, ул. Тукая, 46</p>
        <a href="mailto:info@lenar.ru" class="mail">info@lenar.ru</a>
        <a href="tel:+7 (843) 260-97-79" class="head__contact__title">+7 (843) 260-97-79</a>
        <div class="whatsapp-block-wrapper">
            <a href="https://wa.clck.bar/79656171753">
                <button class="whatsapp-btn">Написать в whatsapp
                    <div class="dot"></div>
                </button>
            </a>
        </div>
